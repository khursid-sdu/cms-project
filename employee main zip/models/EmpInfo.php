...
public $emp_master_department_id_temp,$emp_master_designation_id_temp;
    ...
    public function rules()
    {
        return [
            ...
            [['emp_photo', 'emp_email_id', 'emp_attendance_card_id', 'emp_dob','emp_international_conferences','emp_national_conferences','emp_workshops','emp_membership','emp_rndprojects','emp_bookswritten','emp_paperpublished','emp_aadhaar','emp_pan','emp_voter','emp_bankname','emp_ifsc','university_regd_no','driving_license','emp_guardian_income'], 'safe'],
            ...
            [['emp_attendance_card_id', 'emp_mother_name', 'emp_religion', 'emp_birthplace', 'emp_qualification', 'emp_guardian_qualification', 'emp_guardian_occupation'], 'string', 'max' => 50],
    	    ...
    	    [['is_breakfast','is_dinner'], 'in', 'range' => ['Y','N']],
    ...
    {
        return $this->hasOne(EmpMaster::className(), ['emp_master_emp_info_id' => 'emp_info_id']);
    }
    
    public function getEmpMastersagainnew()
    {
