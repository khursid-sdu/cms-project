...
if(!empty($employee_data) && !empty($selected_list))
{
	...
	echo "<th class='text-center'>".Yii::t('report', 'Employee Full Name')."</th>";
	foreach($selected_list as $s)
	{
		if($s == 'emp_department_name')
			echo "<th class='text-center'>".Yii::t('report','Department')."</th>";
		else if($s == 'emp_cadd')
			echo "<th class='text-center'>".Yii::t('report', 'Present Address')."</th>";
		else if($s == 'emp_padd')
			echo "<th class='text-center'>".Yii::t('report', 'Permanent Address')."</th>";
		...
		else if($s == 'emp_guardian_name')
			echo "<th class='text-center'>".Yii::t('report', 'Father Name')."</th>";
	...
	foreach($employee_data as $t=>$sd)
	{
		...
		echo "<td class='text-center'>".$i."</td>";
			echo "<td class='text-center'>".EmpInfo::findOne($sd['emp_master_emp_info_id'])->emp_title." ".EmpInfo::findOne($sd['emp_master_emp_info_id'])->emp_first_name." ".EmpInfo::findOne($sd['emp_master_emp_info_id'])->emp_middle_name." ".EmpInfo::findOne($sd['emp_master_emp_info_id'])->emp_last_name."</td>";
		foreach($selected_list as $s)
		{
			if($s == 'emp_department_name')
				echo "<td class='text-center'>".EmpDepartment::findOne($sd['emp_master_department_id'])->emp_department_name."</td>";
			else if($s == 'emp_cast')
				echo "<td class='text-center'>".$sd['emp_cast']."</td>";
			else if($s == 'city')
			{
