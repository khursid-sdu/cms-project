 ...
 */
class EmpMasterSpl extends \yii\db\ActiveRecord
{
    public $searchstaffname,$to_date,$fm_date,$student_batch,$branch_of_study;
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['created_at', 'updated_at','emp_cast'], 'safe'],
    ...
    {
        return $this->hasOne(EmpInfoSpl::className(), ['emp_info_emp_master_id' => 'emp_master_id']);
    }
    ...
    {
        return $this->hasOne(EmpInfoSpl::className(), ['emp_info_id' => 'emp_master_emp_info_id']);
    }
