...
class EmpInfoSpl extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['emp_photo', 'emp_email_id', 'emp_attendance_card_id', 'emp_dob','emp_international_conferences','emp_national_conferences','emp_workshops','emp_membership','emp_rndprojects','emp_bookswritten','emp_paperpublished','emp_aadhaar','emp_pan','emp_voter','emp_bankname','emp_ifsc'], 'safe'],
    ...
    {
        return $this->hasOne(EmpMasterSpl::className(), ['emp_master_id' => 'emp_info_emp_master_id']);
    }
    ...
    {
        return $this->hasMany(EmpMasterSpl::className(), ['emp_master_emp_info_id' => 'emp_info_id']);
    }
    ...
    {
        return $this->hasOne(EmpMasterSpl::className(), ['emp_master_emp_info_id' => 'emp_info_id']);
    }
