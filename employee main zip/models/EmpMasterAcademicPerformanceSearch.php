...
class EmpMasterAcademicPerformanceSearch extends EmpMaster
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = EmpMaster::find()->where(['emp_master.is_status' => 0,'emp_master_category_id'=> 1]);
	$query->joinWith(['empMasterEmpInfo','empMasterUser']);
	    ...
	    'sort'=> ['defaultOrder' => ['emp_first_name'=>SORT_ASC]]
        ]);
    ...
    public static function getExportData() 
    {
		$data = [
			...
			'exportFile'=>'@app/modules/academics/views/academicperformancereport/EmpMasterPerformanceExportPdfExcel',
		];
		//print_r($data);exit;
