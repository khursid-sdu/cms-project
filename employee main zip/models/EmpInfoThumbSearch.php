...
class EmpInfoThumbSearch extends EmpInfoThumb
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'emp_unique_id', $this->emp_unique_id])
            ...
            ->andFilterWhere(['like', 'university_regd_no', $this->university_regd_no])
        ...
        $query->joinWith('empMastersagain')->andFilterWhere(['emp_master.emp_master_department_id'=>$this->emp_master_department_id_temp])
        ->andFilterWhere(['emp_master.emp_master_designation_id'=>$this->emp_master_designation_id_temp]);
    ...
    $data = [
            ...
            'fileName'=>'Employee-Thumb-List', 
            'title'=>'Employee Thumb ID Report',
            'exportFile'=>'@app/modules/employee/views/thumballotment/ThumbExportExcel',
        ];
