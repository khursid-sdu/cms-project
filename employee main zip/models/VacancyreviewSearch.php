 ...
 */
class VacancyreviewSearch extends Vacancycreate
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->joinWith('checkallOfficer');
       $query->andFilterWhere(['vacancycreate.is_status'=> 0]);
       $query->andFilterWhere(['vacancyrecommender.forwarded_by'=> Yii::$app->getid->getId()]);
       $query->orderBy(['vacancyrecommender.is_status' => SORT_ASC]);
        return $dataProvider;
    }
