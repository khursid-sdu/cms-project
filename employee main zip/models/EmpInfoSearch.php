...
class EmpInfoSearch extends EmpInfo
{
    ...
    {
        return [
            [['emp_info_id', 'emp_mobile_no', 'emp_experience_year', 'emp_experience_month', 'emp_guardian_mobile_no', 'emp_info_emp_master_id','emp_master_department_id_temp','emp_master_designation_id_temp'], 'integer'],
