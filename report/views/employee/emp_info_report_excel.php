...
if(!empty($employee_data))
{
	...
	foreach($selected_list as $s)
	{
		if($s=='emp_department_name')
			...
			echo "<th style='align:center; valign:'middle';'>".Yii::t('report', 'Present')." </br>".Yii::t('report', 'Address')."</th>";
		else if($s=='emp_padd')
			echo "<th style='align:center; valign:'middle';'>".Yii::t('report', 'Permanent')."</br>".Yii::t('report', 'Address')."</th>";
